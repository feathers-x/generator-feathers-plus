...
module.exports = function(generator) {
  ...
  pkg.scripts = Object.assign(pkg.scripts, specs.options.ts ? {
    ...
    dev: `nodemon --verbose ${specs.app.src}/index.ts`,
    'dev:seed': `nodemon --verbose ${specs.app.src}/index.ts --seed`,
    ...
    dev: `nodemon --verbose ${specs.app.src}/`,
    'dev:seed': `nodemon --verbose ${specs.app.src}/ --seed`,
