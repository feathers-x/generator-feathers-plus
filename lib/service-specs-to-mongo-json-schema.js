...
const discardFields = ['id','createType'];
...
module.exports = function serviceSpecsToMongoJsonSchema (feathersSpec, feathersExtension, depth = 1) {
  ...
  Object.keys(properties).forEach(name => {
    ...
    if (mongoProperty.description) {
      delete mongoProperty.description;
    }
    if(property.items &&  property.items.createType){
      // TODO!
    }
